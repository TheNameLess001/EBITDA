...
mapping = {
    ...
    "Des employés": [
        ...
        "GRATIFICATIONS DE STAGE", "REMPLACEMENTS", "INCITATIONS", "ACHATS PRESTATION admin / RH"
    ],
    "Leasing": [
    ...
    "Publicité et relations publiques": [
        ...
        "LOCATION ESPACE PUBLICITAIRES", "VOYAGES ET DEPLACEMENTS", "FRAIS POSTAUX dhl", "TAXES ECRAN DEVANTURE (1an)"
    ],
    "Services professionnels": [
        "HONORAIRES COMPTA (moore)", "HONORAIRES SOCIAL (moore)", "HONORAIRES DIVERS",
        "HONO PRESTATION FPK MAROC", "CONSEILS", "CONVENTION MEDECIN (1an)", "SOUS TRAITANCE CENTRE D APPEL"
    ],
    "Achats et fournitures": [
        "ACHATS DE MARCHANDISES revente", "ACHAT ALIZEE", "ACHAT BOGOODS", "ACHAT GRAPOS",
        "ACHATS DE FOURNITURES DE BUREAU", "ACHAT TENUES", "STOCK INITIAL", "STOCK FINAL",
    ...
    "Entraînement": [
        ...
        "ABONT FP CLOUD FITNESS PARK France", "ABONT QR CODE FITNESS PARK France", "ABONT MG INSTORE MEDIA (1an)",
        "ABONT TSHOKO (1an)", "ABONT COMBO (1an)", "ABONT CENAREO (1an)", "RESAMANIA HEBERGEMENT SERVEUR",
        "RESAMANIA SMS", "ABONT HYROX 365", "ABONT LICENCE PLANET FITNESS"
    ],
    "Maintenance / Assurances": [
        "ASSURANCE RC CLUB SPORTIF (500 adhérents)", "ASSURANCE RC CLUB SPORTIF provision actif réel",
        "ASSURANCE MULTIRISQUE", "ASSURANCES ACCIDENTS DU TRAVAIL"
    ],
    "CADEAUX / CHALLENGES": [
        "CADEAUX SALARIE ET CLIENT", "CHEQUES CADEAUX POUR CHALLENGES"
    ],
    "HONORAIRES / DIVERS": [
        # déjà inclus dans Services professionnels
    ],
    "REDEVANCES / FP FRANCE": [
        "REDEVANCES FITNESS PARK France 3%"
    ],
    "FRAIS / COMMUNICATION / MARKETING": [
        "FRAIS ET COMMISSIONS SUR SERVICES BANCAI", "FRAIS COMMISSION NAPS",
        "FRAIS COMMISSIONS CMI", "DROITS D'ENREGISTREMENT ET DE TIMBRE"
    ],
    "PERSONNEL / CHARGES SOCIALES": [
        # déjà dans "Des employés"
    ],
    "INTERETS / FINANCE": [
